$(document).ready(function () {
    ...
    $('.vl-menu .li-top-item .a-top-link').each(function () {
    ...
    $('.horizontal-menu .mega-menu-container').each(function () {
        if($(this).hasClass('right')) {
            if($(this).hasClass('full-width')) {
                ...
                var menu = $('.vl-menu-bar').offset();
                var dropdown = $(this).parent().offset();

                var dropdownRight = $('.vl-menu-bar').outerWidth() - dropdown.left;

                var i = (dropdownRight + $(this).outerWidth()) - ($('.vl-menu-bar').outerWidth());
        ...
        if($(this).hasClass('left')) {
            if($(this).hasClass('full-width') == false) {
                ...
                var i = (dropdown.left + $(this).outerWidth()) - (menu.left + $('.vl-menu-bar').outerWidth());
    ...
    $('.vertical-menu .vl-menu-bar').click(function () {
        var effect = $(this).closest('.vl-menu').find('.menu-effect').val();
        if(effect == "none") {
    ...
    $('.mobile-menu .vl-menu-bar .right').click(function () {
        var effect = $(this).closest('.vl-menu').find('.menu-effect').val();
        if(effect == "none") {
    ...
    if($('.vl-menu').hasClass('mobile-menu')) {
