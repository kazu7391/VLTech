...
class ControllerExtensionModuleVlmenu extends Controller
{
    ...
    public function install() {
        ...
        $this->model_vltech_advancemenu->createMenuTable();
    }

    public function uninstall() {
        $this->load->model('vltech/advancemenu');

        $this->model_vltech_advancemenu->deleteMenuData();
    }
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            if (!isset($this->request->get['module_id'])) {
                $this->model_setting_module->addModule('vlmenu', $this->request->post);
            } else {
        ...
        $data['menus'] = array();
        $menuList = $this->model_vltech_advancemenu->getMenuList();
        ...
        if (!isset($this->request->get['module_id'])) {
            $data['action'] = $this->url->link('extension/module/vlmenu', 'user_token=' . $this->session->data['user_token'], true);
            $data['menu_editor_link'] = $this->url->link('vltech/advancemenu/menulist', 'user_token=' . $this->session->data['user_token'], true);
        } else {
            $data['action'] = $this->url->link('extension/module/vlmenu', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
            $data['menu_editor_link'] = $this->url->link('vltech/advancemenu/menulist', 'user_token=' . $this->session->data['user_token'] . '&module_id=' . $this->request->get['module_id'], true);
        }
        ...
        $this->response->setOutput($this->load->view('vl/module/vlmenu', $data));
    }

    protected function validate() {
        if (!$this->user->hasPermission('modify', 'extension/module/vlmenu')) {
